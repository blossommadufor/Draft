...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-fadein">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 sm:p-7 lg:p-8 rounded-3xl bg-white dark:bg-gradient-to-r dark:from-dark-900 dark:via-dark-850 dark:to-dark-900 border border-slate-200 dark:border-white/[0.08] shadow-sm relative overflow-hidden">
        <div>
        ...
        <button
          ...
          className="w-full sm:w-auto px-5 sm:px-6 py-3 rounded-2xl bg-gradient-to-r from-brand-600 to-brand-500 hover:from-brand-500 hover:to-brand-400 text-white font-bold text-xs sm:text-sm shadow-glow-brand active:scale-95 transition-all flex items-center justify-center gap-2 shrink-0"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-stretch">
        ...
        <div className="lg:col-span-7 p-5 sm:p-6 rounded-3xl bg-white dark:bg-dark-900 border border-slate-200 dark:border-white/[0.08] shadow-sm flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
              {streakMilestones.map((m, idx) => (
                <div
                  key={idx}
                  className={`p-3 sm:p-3.5 rounded-2xl border text-center flex flex-col items-center justify-center transition-all ${
                    m.unlocked
          ...
          <div className="mt-5 sm:mt-6 pt-4 border-t border-slate-100 dark:border-white/[0.06] flex items-center justify-between text-xs">
