...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 sm:p-8 bg-slate-50 dark:bg-dark-950 transition-colors">
      <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-6 space-y-4">
          ...
          <div className="pt-2">
            <Link
              to="/dashboard"
              className="text-xs font-semibold text-slate-500 dark:text-slate-400 hover:text-brand-600 dark:hover:text-white flex items-center gap-1.5 transition-colors"
            >
        ...
        <div className="lg:col-span-6 p-6 sm:p-8 rounded-3xl bg-white dark:bg-dark-900 border border-slate-200 dark:border-white/[0.08] shadow-2xl space-y-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full p-4 rounded-2xl bg-slate-50 dark:bg-dark-950 border border-slate-200 dark:border-white/[0.06] hover:border-brand-500/50 hover:bg-brand-500/[0.03] transition-all flex items-center justify-between group text-left"
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-brand-500/10 text-brand-600 dark:text-brand-400 flex items-center justify-center group-hover:scale-105 transition-transform">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">Active recall cards from PDF or notes</p>
                </div>
              </div>
            ...
            <button
              ...
              className="w-full p-4 rounded-2xl bg-slate-50 dark:bg-dark-950 border border-slate-200 dark:border-white/[0.06] hover:border-gold-500/50 hover:bg-gold-500/[0.03] transition-all flex items-center justify-between group text-left"
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gold-500/10 text-gold-600 dark:text-gold-400 flex items-center justify-center group-hover:scale-105 transition-transform">
                  <HelpCircle className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 group-hover:text-gold-600 dark:group-hover:text-gold-400 transition-colors">
                    Generate multiple choice ques.
                  </h4>
                  <p className="text-[11px] text-slate-500">Timed exam simulator with answers</p>
                </div>
              </div>
              <ArrowRight className="w-4 h-4 text-slate-400 group-hover:text-gold-500 group-hover:translate-x-1 transition-all" />
            </button>

            {/* Action 3: Study Notes */}
            <button
              onClick={() => navigate('/dashboard/notes')}
              className="w-full p-4 rounded-2xl bg-slate-50 dark:bg-dark-950 border border-slate-200 dark:border-white/[0.06] hover:border-emerald-500/50 hover:bg-emerald-500/[0.03] transition-all flex items-center justify-between group text-left"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">High-yield cheat sheets and key formulas</p>
                </div>
              </div>
            ...
            <button
              ...
              className="w-full p-4 rounded-2xl bg-slate-50 dark:bg-dark-950 border border-slate-200 dark:border-white/[0.06] hover:border-cyan-500/50 hover:bg-cyan-500/[0.03] transition-all flex items-center justify-between group text-left"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">Ask questions and clarify difficult concepts</p>
                </div>
              </div>
