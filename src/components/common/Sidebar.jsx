...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`relative z-20 shrink-0 border-r border-slate-200 dark:border-white/[0.08] bg-slate-50/80 dark:bg-dark-900/50 backdrop-blur-xl transition-all duration-300 flex flex-col ${
        collapsed ? 'w-16' : 'w-64'
      }`}
    >
      ...
      {/* Active Study Set Quick Indicator */}
      {!collapsed && activeSet && (
