...
export default function ValueProps() {
  ...
  return (
    <section className="py-16 border-t border-white/[0.06] bg-dark-900/30">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {props.map((p, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-6 rounded-3xl bg-dark-850/60 border border-white/[0.06] hover:border-white/15 transition-all duration-300 hover:-translate-y-1 group"
              >
