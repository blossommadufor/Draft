...
export default function PricingSection() {
  ...
  return (
    <section className="py-12 sm:py-20 border-t border-slate-200 dark:border-white/[0.08] bg-slate-50/50 dark:bg-dark-900/40">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
          ...
          <div className="mt-6 sm:mt-8 inline-flex items-center p-1 rounded-2xl bg-slate-200/80 dark:bg-dark-800 border border-slate-300 dark:border-white/10">
            <button
              ...
              className={`px-4 sm:px-5 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all min-h-[38px] ${
            ...
            <button
              ...
              className={`px-4 sm:px-5 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all flex items-center gap-1.5 min-h-[38px] ${
                billingCycle === 'yearly'
                  ? 'bg-white dark:bg-brand-600 text-brand-700 dark:text-white shadow-md'
                  : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
              }`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-stretch">
          ...
          {/* Tier 1: Starter */}
          <div className="p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white dark:bg-dark-850/60 border border-slate-200 dark:border-white/[0.06] flex flex-col justify-between hover:border-slate-300 dark:hover:border-white/15 transition-all shadow-sm">
            <div>
            ...
            <button
              ...
              className="w-full py-3 min-h-[44px] rounded-xl bg-slate-100 dark:bg-white/[0.06] hover:bg-slate-200 dark:hover:bg-white/[0.1] text-slate-800 dark:text-slate-200 font-semibold text-xs border border-slate-200 dark:border-white/10 transition-colors flex items-center justify-center"
            >
              Get Started
            </button>
          </div>
          ...
          <div className="p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white dark:bg-gradient-to-b dark:from-dark-800 dark:to-dark-900 border-2 border-brand-500 shadow-xl dark:shadow-glow-brand flex flex-col justify-between relative transform md:-translate-y-2">
            ...
            <button
              onClick={handleAction}
              className="w-full py-3.5 min-h-[44px] rounded-xl bg-gradient-to-r from-brand-600 via-brand-500 to-indigo-600 hover:from-brand-500 hover:to-indigo-500 text-white font-bold text-xs sm:text-sm shadow-glow-brand transition-all active:scale-95 flex items-center justify-center"
            >
              Start Full Access
            </button>
          </div>
            ...
            <div>
              ...
              <div className="my-5">
                ...
                <input
                  ...
                  className="w-full accent-brand-500 cursor-pointer h-2 bg-slate-200 dark:bg-dark-700 rounded-lg min-h-[36px]"
                />
