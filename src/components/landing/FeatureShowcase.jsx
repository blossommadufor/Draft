    ...
    <section id="features" className="py-24 space-y-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-6 space-y-5">
          ...
          <div className="pt-2">
            <button
              ...
              className="inline-flex items-center gap-2 text-sm font-semibold text-brand-600 dark:text-brand-400 hover:text-brand-500 group"
            >
        ...
        <div className="lg:col-span-6 relative">
          <div className="p-8 rounded-3xl bg-white dark:bg-gradient-to-br dark:from-dark-850 dark:to-dark-900 border border-slate-200 dark:border-white/10 shadow-2xl relative overflow-hidden">
            <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 mb-6">
              ...
              <span className="px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 font-mono font-semibold">
                Computer Science
              </span>
            </div>

            <div className="min-h-[160px] flex flex-col justify-center text-center p-6 rounded-2xl bg-slate-50 dark:bg-dark-950/60 border border-slate-200 dark:border-white/[0.06]">
              <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400 mb-2">Question</span>
              ...
              <p className="mt-3 text-xs text-brand-600 dark:text-brand-400 font-medium">Tap or press Space to reveal answer</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-6 lg:order-2 space-y-5">
          ...
          <div className="pt-2">
            <button
              ...
              className="inline-flex items-center gap-2 text-sm font-semibold text-gold-600 dark:text-gold-400 hover:text-gold-500 group"
            >
        ...
        <div className="lg:col-span-6 lg:order-1">
          <div className="p-8 rounded-3xl bg-white dark:bg-dark-900 border border-slate-200 dark:border-white/10 shadow-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6">
          <div className="p-6 rounded-3xl bg-white dark:bg-dark-900 border border-slate-200 dark:border-white/10 shadow-2xl space-y-3">
            ...
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-xl bg-cyan-500/20 text-cyan-600 dark:text-cyan-300 flex items-center justify-center shrink-0">
